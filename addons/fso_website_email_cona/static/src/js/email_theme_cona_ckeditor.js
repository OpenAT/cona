    ...
    openerp.website.RTE = openerp.website.RTE.extend({
        _config: function () {
            ...
            config.stylesSet = [
                ...
                {name: 'p Klein', element: 'p', attributes: { 'class': 'cona_small' } },
                {name: 'p Winzig', element: 'p', attributes: { 'class': 'cona_tiny' } },
                ...
                // {name: 'Klein', element: 'span', attributes: { 'class': 'cona_small_text' } },
                // {name: 'Sehr-Klein', element: 'span', attributes: { 'class': 'cona_very_small_text' } },
            ];
